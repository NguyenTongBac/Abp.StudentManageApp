...
{
    [DbContext(typeof(StudentManageDbContext))]
    [Migration("20220709181253_phase2_addTable_Student")]
    partial class phase2_addTable_Student
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.StudentManage.Entities.Common.Lop", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppLops", "common");
                });

            modelBuilder.Entity("Acme.StudentManage.Entities.Common.SinhVien", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.StudentManage.Entities.Common.SinhVien", b =>
                {
                    b.HasOne("Acme.StudentManage.Entities.Common.Lop", "Lop")
                        .WithMany("SinhViens")
                        .HasForeignKey("LopID")
