...
public class StudentManageDbContext :
    AbpDbContext<StudentManageDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(StudentManageConsts.DbTablePrefix + "YourEntities", StudentManageConsts.DbSchema);
